...
function searchCar(){
    ...
    var carPage=carModel.options[carModel.selectedIndex].text+"dark.html";
...
function mercedes() {
    "use strict";
    window.location.href = "Mercedes_carsdark.html";
}function bmw() {
    "use strict";
    window.location.href = "BMW_carsdark.html";
}function audi() {
    "use strict";
    window.location.href = "Audi_carsdark.html";
}